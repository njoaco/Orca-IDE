...
class QsciLexerAsm(QsciLexer):
    ...
    Operator = ... # type: int
    Identifier = ... # type: int
    CPUInstruction = ... # type: int
    FPUInstruction = ... # type: int
    Register = ... # type: int
    Directive = ... # type: int
    DirectiveOperand = ... # type: int
    BlockComment = ... # type: int
    SingleQuotedString = ... # type: int
    UnclosedString = ... # type: int
    ExtendedInstruction = ... # type: int
    CommentDirective = ... # type: int
...
class QsciLexerHex(QsciLexer):
    ...
    Default = ... # type: int
    RecordStart = ... # type: int
    RecordType = ... # type: int
    UnknownRecordType = ... # type: int
    ByteCount = ... # type: int
    IncorrectByteCount = ... # type: int
    NoAddress = ... # type: int
    DataAddress = ... # type: int
    RecordCount = ... # type: int
    StartAddress = ... # type: int
    ExtendedAddress = ... # type: int
    OddData = ... # type: int
    EvenData = ... # type: int
    UnknownData = ... # type: int
    Checksum = ... # type: int
    IncorrectChecksum = ... # type: int
    TrailingGarbage = ... # type: int
